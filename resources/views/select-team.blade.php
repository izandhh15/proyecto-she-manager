    ...
    <div class="max-w-7xl mx-auto px-4 pb-8">
        ...
        <div class="mt-6 mb-6">
            ...
            <p class="mt-2 max-w-3xl text-sm md:text-base text-text-secondary">
                Construye tu proyecto en el fÃºtbol femenino: elige club o selecciÃ³n, define una identidad de juego y compite temporada a temporada.
            </p>
        </div>
                                    ...
                                    <div class="flex items-center gap-3">
                                        ...
                                        <div class="min-w-0">
                                            ...
                                            <p class="text-sm text-text-secondary">
                                                {{ __($competition->name) }} Â· {{ $competition->teams->count() }} clubes
                                            </p>
                                        </div>
                                    </div>
                                </div>
