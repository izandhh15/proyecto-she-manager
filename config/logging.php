...
$defaultLogChannel = env('LOG_CHANNEL', app()->environment('production') ? 'stderr' : 'stack');
$defaultLogStack = env('LOG_STACK', app()->environment('production') ? 'stderr' : 'single');
...
return [
    ...
    */
    ...
    'channels' => [
        ...
        'stack' => [
            'driver' => 'stack',
            'channels' => explode(',', $defaultLogStack),
